...
for (run in 1:100) {
  ...
  #stage1 <- MrOS_clinical21[, !names(MrOS_clinical21) %in% c("HA_THD", "HA_LSD", "HA_FND", "HA_VITAL","HA_WRSTFXFU","HA_SLDFXFU","HA_CALCIUM","HA_CROFTOA")]
  #stage <- stage1
 stage2 <- MrOS_clinical21[, !names(MrOS_clinical21) %in% c("HA_WRSTFXFU","HA_SLDFXFU","HA_VITAL")]
  stage <- stage2
