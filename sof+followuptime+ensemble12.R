...
stage1 <- SOF_clinical21[, !names(SOF_clinical21) %in% c("HA_THD", "HA_LSD", "HA_FND","HA_WRSTFXFU","HA_SLDFXFU","HA_CALCIUM","HA_CROFTOA","HA_VITAL")]
stage <- stage1
...
head(SOF_clinical1[, c("HA_AGE", "HA_RACE", "HA_THD", "HA_LSD", "HA_FND")])
SOF_clinical <- SOF_clinical1
#ensemble2.optVariables <- c("HA_FND", "HA_THD", "HA_LSD", "HA_SLDFX", "HA_WLKSPED", "HA_MMSE",
 #                           "HA_WRSTFX", "HA_GRIPAVG", "HA_HEIGHT", "HA_AGE", "HA_TRLBTS", "HA_BMI",
  #                          "HA_IADL51", "HA_SMOKE","HA_HIPFXFU","HA_WRSTFXFU","HA_SLDFXFU","HA_HIPFX")


ensemble1.optVariables <- c("HA_WRSTFX", "HA_MMSE", "HA_HEIGHT", "HA_WLKSPED", "HA_SLDFX","HA_TRLBTS","HA_AGE","HA_HIPFX")
optVariables <- ensemble1.optVariables
stage_clean <- na.omit(SOF_clinical[,optVariables])
X <- stage_clean[, -which(names(stage_clean) == "HA_HIPFX")]
