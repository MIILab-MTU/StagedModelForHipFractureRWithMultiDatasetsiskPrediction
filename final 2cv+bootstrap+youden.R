...
#y <- as.factor(y)
#df <- cbind(X,y)
#df <- SOF_clinical[, c("HA_HIPFXFU", "HA_WRSTFXFU", "HA_SLDFXFU", "HA_WRSTFX",
...
df <- SOF_clinical[, c("HA_FND", "HA_THD", "HA_LSD", "HA_SLDFX", "HA_WLKSPED", "HA_MMSE",
"HA_WRSTFX", "HA_GRIPAVG", "HA_HEIGHT", "HA_AGE", "HA_TRLBTS", "HA_BMI",
"HA_IADL51", "HA_SMOKE", "HA_HIPFX")]


# Define Clinical and DXA Features
clinical_features <- c( "HA_SLDFX", "HA_WLKSPED", "HA_MMSE",
"HA_WRSTFX", "HA_GRIPAVG", "HA_HEIGHT", "HA_AGE", "HA_TRLBTS", "HA_BMI",
"HA_IADL51", "HA_SMOKE")
#### for test
...
SOF_clinical <- read.table("/Users/mac/Desktop/dissertation/cooperation/SOF_data/sof.txt", 
                           header = TRUE, sep = "\t", na.strings = c("", "NA", " "))
df <- SOF_clinical[, c("HA_FND", "HA_THD", "HA_LSD",  "HA_MMSE",
                        "HA_HEIGHT", "HA_AGE", "HA_BMI", "HA_HIPFX")]

# Define Clinical and DXA Features
clinical_features <- c(  "HA_MMSE",
                         "HA_HEIGHT", "HA_AGE", "HA_BMI")
...
###############
ensemble2.optVariables <- c("HA_THD", "HA_LSD", "HA_FND", "HA_SLDFX", "HA_WLKSPED", "HA_MMSE",
                            "HA_WRSTFX", "HA_GRIPAVG", "HA_HEIGHT", "HA_AGE", "HA_TRLBTS", "HA_BMI",
                            "HA_IADL51", "HA_SMOKE","HA_HIPFXFU","HA_WRSTFXFU","HA_SLDFXFU","HA_HIPFX")
df <- SOF_clinical[,ensemble2.optVariables]
# Define Clinical and DXA Features
clinical_features <- c(  "HA_SLDFX", "HA_WLKSPED", "HA_MMSE",
                         "HA_WRSTFX", "HA_GRIPAVG", "HA_HEIGHT", "HA_AGE", "HA_TRLBTS", "HA_BMI",
                         "HA_IADL51", "HA_SMOKE","HA_HIPFXFU","HA_WRSTFXFU","HA_SLDFXFU")
