UK <- read.csv("/Users/mac/Desktop/dissertation/cooperation/uk600.csv", header = TRUE, stringsAsFactors = FALSE)
#UK <- read.csv("/Users/mac/Desktop/dissertation/cooperation/uk1200.csv", header = TRUE, stringsAsFactors = FALSE)
str(UK)
...
colnames(UK) <- c("ID", "age", "totalbmd", "smoke", "spinebmd", "leftgrip", "rightgrip", 
                  ...
                  "leftneckbmdtscore", "rightneckbmdtscore","totalbmdleft","totalbmdright","weight")
...
write.csv(UK, "/Users/mac/Desktop/dissertation/cooperation/FOS/UK_mytscore600.dataset.csv", row.names = FALSE)
